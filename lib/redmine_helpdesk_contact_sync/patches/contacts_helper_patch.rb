  ...
  module Patches
    module ContactsHelperPatch
      def self.included(base)
        ...
        base.class_eval do
          alias_method :select_contact_tag_without_hcs, :select_contact_tag
          alias_method :select_contact_tag, :select_contact_tag_with_hcs
        end
      end

      module InstanceMethods
        def select_contact_tag_with_hcs(name, contacts, options = {})
